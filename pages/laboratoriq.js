    ...
    >
      <main className="main">
        <div className={`contenedor ${styles.contenido}`}>
          ...
          <Image src={`/img/lab/lab1.jpg`} width={400} height={400} alt={'Image Laboratory 1'} />
          <Image src={`/img/lab/lab2.jpg`} width={400} height={400} alt={'Image Laboratory 2'} />
          <Image src={`/img/lab/lab3.jpg`} width={400} height={400} alt={'Image Laboratory 3'} />
          <Image src={`/img/lab/lab4.jpg`} width={400} height={400} alt={'Image Laboratory 4'} />
          <Image src={`/img/lab/lab5.jpg`} width={400} height={400} alt={'Image Laboratory 5'} />
          <Image src={`/img/lab/lab6.jpg`} width={400} height={400} alt={'Image Laboratory 6'} />
          </div>
          </div>
          <News />
